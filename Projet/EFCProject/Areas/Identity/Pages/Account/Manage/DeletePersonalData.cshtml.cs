...
namespace EFCProject.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            if (user == null)
            {
                return NotFound($"Impossible de charger l'utilisateur avec l'ID spécifié. '{_userManager.GetUserId(User)}'.");
            }
